...
def main():
    ...
    # file_path += 'CIC-IDS-2017-PCAPS1-f10/CIC-IDS-2017_Flow_v0_c10.csv'
    # file_path += 'CIC-IDS-2018-PCAPS1-f10/CIC-IDS-2018_Flow_v0_c10.csv'
    file_path += "CIC-IoMT-2024-PCAPS1-f10/CIC-IoMT-2024_Flow_v0_c19.csv"
    # file_path += 'CIC-IOT-2023-PCAPS1-f10/CIC-IOT-2023_Flow_v0_c4.csv'
    # file_path += 'CIC-IOT-2023-32-PCAPS1-f10/CIC-IOT-2023-32_Flow_v0_c32.csv'
    # file_path += 'ISCXVPN2016-PCAPS0-f10/ISCXVPN2016_Flow_v0_c13.csv'
    # file_path += 'UCSBFinetuning-PCAPS0-f10/UCSBFinetuning_Flow_v0_c11.csv'
